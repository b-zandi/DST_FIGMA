      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/learn-more" className="text-gray-600 hover:text-gray-900">
                  What is a DST?
                </Link>
              </li>
              <li>
                <Link href="/learn-more/tax" className="text-gray-600 hover:text-gray-900">
                  Tax Benefits
                </Link>
              </li>
              <li>
                <Link href="/learn-more/protection" className="text-gray-600 hover:text-gray-900">
                  Asset Protection
                </Link>
              </li>
              <li>
                <Link href="/learn-more/income" className="text-gray-600 hover:text-gray-900">
                  Passive Income
                </Link>
              </li>
            </ul>

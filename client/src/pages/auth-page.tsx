      ...
      <main className="flex-grow py-10 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
          {registrationStage === 'questionnaire' ? (
            // Full width layout for questionnaire with its own sidebar
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="p-8 lg:p-10">
                <div className="mb-6">
                  <h1 className="text-3xl font-bold text-[#1A2B50] mb-2">Investor Questionnaire</h1>
            ...
            // Standard two-column layout for login/register/results

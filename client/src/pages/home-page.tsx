  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        {/* Why Choose a DST Investment Vehicle Section */}
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-md transition-shadow">
                  ...
                  <p className="text-gray-600">
                    Receive regular distributions from professionally managed properties without the hassles of direct management.
                  </p>
                </div>
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-md transition-shadow">
                  ...
                  <p className="text-gray-600">
                    Benefit from structured liability protection providing added security.
                  </p>
                </div>
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-md transition-shadow">
                  <div className="mb-4">
                    <div className="h-10 w-10 bg-blue-100 rounded flex items-center justify-center">
                      <div className="w-5 h-5 bg-blue-600 transform rotate-45"></div>
                    </div>
                  </div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-3">
                    Tax Advantages
                  ...
                  <p className="text-gray-600">
                    Take advantage of potential tax deferrals through 1031 exchanges and other tax benefits.
                  </p>
                </div>
              </div>
